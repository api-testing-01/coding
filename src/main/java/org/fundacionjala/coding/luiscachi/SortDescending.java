...
public class SortDescending {
    public String sortDescending(String sortDescending) {
        String wordsToSort[] = sortDescending.split(" ");
        for (int i = 0; i < wordsToSort.length ; i++) {
            if (wordsToSort[i].length() > 3) {
                ...
                wordsToSort[i] = wordsToSort[i].charAt(0) + sortDes + wordsToSort[i].charAt(wordsToSort[i].length() - 1);
            }
        }
