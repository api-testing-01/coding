...
public class BankOCRTest {
    ...
    public void userStory2Test() {
        ...
        Assert.assertEquals(0, ocr.userStory2("345882865"));
        Assert.assertTrue("Account is valid", ocr.validateUserStory2("345882865"));
        Assert.assertEquals(0, ocr.userStory2("457508000"));
        Assert.assertTrue("Account is valid", ocr.validateUserStory2("457508000"));
        Assert.assertNotEquals(0, ocr.userStory2("664371495"));
        Assert.assertFalse("Account is not valid", ocr.validateUserStory2("664371495"));
    }
